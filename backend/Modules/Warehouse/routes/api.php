...
Route::middleware(['auth:sanctum', 'is_admin'])->prefix('admin/stock')->group(function () {
    ...
    Route::patch('/balances/lots/{id}', [StockBalanceController::class, 'updateLotComment']);
    ...
    Route::prefix('receipts')->group(function () {
        ...
        Route::post('/import-supplier-xlsx', [StockReceiptController::class, 'importSupplierXlsx']);
        Route::post('/{id}/post', [StockReceiptController::class, 'postReceipt']);
        Route::post('/{id}/post-and-distribute', [StockReceiptController::class, 'postAndDistribute']);
    ...
    Route::prefix('writeoffs')->group(function () {
        ...
        Route::post('/{id}/write-off', [StockWriteoffController::class, 'writeOff']);
    });
