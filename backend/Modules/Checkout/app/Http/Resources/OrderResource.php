...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'additional_delivery_street_prefix' => $this->additional_delivery_street_prefix,
            'additional_delivery_address' => $this->additional_delivery_address,
            'additional_delivery_house' => $this->additional_delivery_house,
            'additional_delivery_korpus' => $this->additional_delivery_korpus,
            'additional_delivery_apartment' => $this->additional_delivery_apartment,
