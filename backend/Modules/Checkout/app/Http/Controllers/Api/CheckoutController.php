...
class CheckoutController extends Controller
{
    public function checkout(Request $request, CheckoutQuoteService $quoteService): JsonResponse
    {
        $validated = $request->validate([
            ...
            'additional_delivery_street_prefix' => ['nullable', 'string', 'max:32'],
            'additional_delivery_address' => ['nullable', 'string', 'max:500'],
            'additional_delivery_house' => ['nullable', 'string', 'max:32'],
            'additional_delivery_korpus' => ['nullable', 'string', 'max:32'],
            'additional_delivery_apartment' => ['nullable', 'string', 'max:32'],
        ...
        $order = DB::transaction(function () use (
            ...
            $order = Order::query()->create([
                ...
                'additional_delivery_street_prefix' => $validated['additional_delivery_street_prefix'] ?? null,
                'additional_delivery_address' => $validated['additional_delivery_address'] ?? null,
                'additional_delivery_house' => $validated['additional_delivery_house'] ?? null,
                'additional_delivery_korpus' => $validated['additional_delivery_korpus'] ?? null,
                'additional_delivery_apartment' => $validated['additional_delivery_apartment'] ?? null,
