...
class ShopSettingAdminController extends Controller
{
    public function show(ShopSettingService $settings): JsonResponse
    {
        return response()->json([
            'data' => [
                ...
                'legal_name' => (string) $settings->get('legal_name', 'ИП Гришкевич П.А.'),
                'legal_unp' => (string) $settings->get('legal_unp', '191168408'),
                'legal_address' => (string) $settings->get('legal_address', ''),
    ...
    public function update(Request $request, ShopSettingService $settings): JsonResponse
    {
        $validated = $request->validate([
            ...
            'legal_unp' => ['nullable', 'string', 'max:32'],
            'legal_address' => ['nullable', 'string', 'max:512'],
