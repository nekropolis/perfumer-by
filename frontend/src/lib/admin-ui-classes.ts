...
export const adminPageTitle = "text-xl font-semibold tracking-tight text-admin-text sm:text-2xl";

export const adminPageSubtitle = "mt-1 text-sm leading-relaxed text-admin-text-secondary";
...
export const adminTableCell = "border-b border-admin-border/80 px-3 py-2.5 text-sm leading-snug text-admin-text";
