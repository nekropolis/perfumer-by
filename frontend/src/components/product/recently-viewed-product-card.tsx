...
export default function RecentlyViewedProductCard({ product }: Props) {
    ...
    return (
        <Link
            href={`/${product.slug}`}
            className="flex h-full min-w-0 w-full items-start gap-2 rounded-2xl border border-admin-border bg-admin-surface px-2 py-1.5 transition duration-200 ease-out active:scale-[0.99] lg:hover:z-10 lg:hover:scale-[1.03] lg:hover:border-admin-border-strong lg:hover:bg-admin-bg lg:hover:shadow-md"
        >
