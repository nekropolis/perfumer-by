                                    ...
                                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                        ...
                                        <div className="hidden shrink-0 items-center gap-1.5 sm:flex">
                                            <button
                                                type="button"
                                                onClick={() => openEdit(item)}
                                                className="inline-flex h-7 items-center gap-1 rounded-lg border px-2 text-[11px] text-admin-text transition hover:bg-white"
                                                title="Редактировать"
                                                aria-label="Редактировать"
                                            >
                                                <svg
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => setDeleteTarget(item)}
                                                className="inline-flex h-7 items-center gap-1 rounded-lg border border-red-200 px-2 text-[11px] text-red-600 transition hover:bg-red-50"
                                                title="Отвязать"
                                                aria-label="Отвязать"
                                            >
                                                <svg
                            ...
                            <div className="space-y-4 overflow-y-auto px-5 py-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled
                                        className="w-full rounded-lg border bg-admin-muted px-3 py-2 text-sm text-admin-text-secondary"
                                    />
                                </div>
