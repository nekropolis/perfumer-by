            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
                <thead className="bg-admin-muted">
                    <tr>
                        ...
                        <th className="px-4 py-3 text-left font-medium text-admin-text-secondary">Slug</th>
                ...
                <tbody className="divide-y divide-gray-100 bg-white">
                    {items.map((item) => (
                        <tr key={item.id}>
                            ...
                            <td className="px-4 py-3 text-admin-text-secondary">/{item.slug}</td>
                            ...
                            <td className="px-4 py-3">
                                <div className="flex items-center justify-end gap-2">
                                    <Link href={`/admin/pages/${item.id}/edit`} className="rounded-lg border px-3 py-1.5 text-xs font-medium text-admin-text transition hover:bg-admin-muted">
                                        Редактировать
                                    </Link>
                                    <button
                                        type="button"
