...
export default function AdminPricingLogicPage() {
    return (
        <AdminPageCard>
            <div className="mx-auto max-w-3xl space-y-6 rounded-2xl border bg-white p-6 text-sm leading-relaxed text-admin-text">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        <h1 className="text-lg font-semibold">Логика цен</h1>
