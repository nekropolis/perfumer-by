            ...
            <section className="space-y-2">
                ...
                <ul className="list-disc space-y-1 pl-5">
                    ...
                    <li>
                        ...
                        30% → ручная очередь («Разница офер &gt;30%») с розницей через формулу (BYN), витрина
                        выкл. Иначе — auto-apply.
                    </li>
                    <li>
                        Склад &gt; офер и разница &gt; 10% → расчётная = склад − 10%, розница = формула от
                        расчётной (BYN), ручная очередь («Разница склад &gt;10%»).
                    </li>
